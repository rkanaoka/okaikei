...
const tables_service_1 = require("../../../modules/tables/application/use-cases/tables.service");
let TablesController = class TablesController {
    constructor(tables) {
        this.tables = tables;
    }
    findAll() { return this.tables.findAll(); }
    create(b) { return this.tables.create(b); }
    update(id, b) { return this.tables.update(id, b); }
};
