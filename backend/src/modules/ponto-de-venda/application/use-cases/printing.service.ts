...
import { PRINTER_REPOSITORY_PORT, PrinterRepositoryPort } from '@/modules/ponto-de-venda/domain/repositories/printer-repository.port';
import { ESC_POS_CLIENT_PORT, EscPosClientPort }          from '@/modules/ponto-de-venda/application/contracts/esc-pos-client.port';
import {
  TemplateType, DEFAULT_CONFIGS, DEFAULT_ENABLED, isTemplateType,
} from '@/modules/ponto-de-venda/application/use-cases/print-template-defaults';
